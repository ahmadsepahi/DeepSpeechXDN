...
public class CreateServices {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, JSONException {
        ...
        json.put(DockerKeys.NAME.toString(), "deepspeech_orig");
        ...
        json.put(DockerKeys.VOL.toString(), "deepspeech_orig");

        final int sent = 1;

        testServiceName = "deepspeech_orig"+ XDNConfig.xdnServiceDecimal+"Alvin";
