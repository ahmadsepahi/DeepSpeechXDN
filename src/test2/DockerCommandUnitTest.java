...
public class DockerCommandUnitTest {
    ...
    public static void main(String[] args) throws JSONException, IOException, InterruptedException {
        ...
        json.put(DockerKeys.NAME.toString(), "deepspeech_orig"+ XDNConfig.xdnServiceDecimal+"Alvin");
        json.put(DockerKeys.IMAGE_URL.toString(), "ahmadsepahi/deepspeech_orig");
        json.put(DockerKeys.PORT.toString(), 8000);

        restore(json.toString(), "deepspeech_orig"+ XDNConfig.xdnServiceDecimal+"Alvin", "deepspeech_orig");
